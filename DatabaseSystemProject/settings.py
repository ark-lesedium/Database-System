...
# Your existing BASE_DIR setting
BASE_DIR = Path(__file__).resolve().parent.parent

"""


Django settings for DatabaseSystemProject project.
...
SECRET_KEY = 'django-insecure-53evot#$87m_6o!z@g-1zu3p+^i+@e((y4n*q(&ohxo+i*2vaa'
...
ROOT_URLCONF = 'DatabaseSystemProject.urls'
...
WSGI_APPLICATION = 'DatabaseSystemProject.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'MainInterface/static')]
